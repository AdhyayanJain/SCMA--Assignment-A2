...
# Output: Working directory changed to 'D:\\#YPR\\VCU\\Summer Courses\\SCMA\\Data'

# Get the current working directory
getwd()
# Output: 'D:\\#YPR\\VCU\\Summer Courses\\SCMA\\Data'
...
print(summary_runs)
# Output: Summary of linear regression model for runs
...
# Output: Summary of linear regression model for wickets
...
# Output: R-squared value for runs
...
# Output: R-squared value for wickets
